/// @description  Draw the Menu
    ...
    draw_sprite_ext(spr_black_dot, 0, __view_get( e__VW.XView, 0 )+16, __view_get( e__VW.YView, 0 ), 160, 360, 0, c_black, 1);
    draw_set_font(font);
    ...
    switch(optPage)
    {
        case 0:
        {
            ...
            draw_text_color_selected(__view_get( e__VW.XView, 0 )+96, __view_get( e__VW.YView, 0 )+360-64, "Exit Game", (option==2), c_white, c_gray);
            break;
        }
        ...
        case 1:
        {
            ...
            draw_text_color_selected(__view_get( e__VW.XView, 0 )+96, __view_get( e__VW.YView, 0 )+360-64, "Back to Menu", (option==5), c_white, c_gray);
            break;
        }
        ...
        case 2:
        {
            ...
            draw_text_color_selected(__view_get( e__VW.XView, 0 )+96, __view_get( e__VW.YView, 0 )+360-64, "Back", (option==2), c_white, c_gray);
            break;
        }
    ...
    draw_sprite_ext(spr_namebar, 0, __view_get( e__VW.XView, 0 )-7, __view_get( e__VW.YView, 0 )+360-36, 2, 1, 0, c_white, 1);
    draw_set_align(fa_left, fa_middle);
	draw_text_color_custom(__view_get( e__VW.XView, 0 )+16, __view_get( e__VW.YView, 0 )+360-36+(string_height(string_hash_to_newline(optDescript))/2), optDescript, c_white);
    draw_set_align(-1, -1);
