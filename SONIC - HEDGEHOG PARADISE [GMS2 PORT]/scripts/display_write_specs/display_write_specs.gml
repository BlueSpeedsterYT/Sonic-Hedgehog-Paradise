/// @description display_write_specs(display_enum)
/// @param display_enum
function display_write_specs() {
	enum display{screen, window, gui, app_surface, view, frames, true_frames};
	var str="";
	switch(argument[0])
	{
	  case display.screen:
	  ...
	  case display.frames:
	    str="FPS: "+string(fps);
	  break;
	  case display.true_frames:
	    str="True FPS: "+string(fps_real);
	  break;
	}
	return str;
