/// @description  player_collision_check(COL_?, ARGUMENTS);
/// @param COL_?
/// @param  ARGUMENTS
	 ...
	 // Slope sensor (Platform fix)
	    ...
	    {    
	       if(not ground)
	       {
	         ...
	         // Test collision:    
	            var colTest;
	            colTest = (!place_meeting(x, y, par_platform) && !player_collision_check(COL_BOTTOM_OBJECT, MASK_BIG, x, y, angle, par_platform) && !player_collision_check(COL_TOP_OBJECT, MASK_BIG, x, y-6, angle, par_platform) && place_meeting(floor(argument[2] + dsin(argument[4])*23),
	                                                                                                                                                                                                                                                floor(argument[3] + dcos(argument[4])*23),
	                                                                                                                                                                                                                                                par_platform));        
	         // Restore previous mask.
	            mask_index = maskTemp;
